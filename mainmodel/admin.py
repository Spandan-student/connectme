...
from .models import personal_details_models,personal_skill_models,personal_team_models,personal_academics_models,profile_score_models,personal_connections_models
...
admin.site.register(personal_connections_models)